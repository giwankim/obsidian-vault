---
title: "Stevey's Blog Rants: Get that job at Google"
source: "https://steve-yegge.blogspot.com/2008/03/get-that-job-at-google.html"
author:
  - "[[Steve Yegge]]"
...
> [!summary]
> Steve Yegge's classic, irreverent guide to preparing for software-engineering interviews at Google-like companies. He explains the high false-negative rate and the "interview anti-loop" so candidates don't take rejection personally (just reapply in 6–12 months), then gives concrete prep: warm up on whiteboard problems, have a friend mock-interview you, and study data structures and algorithms cold — especially graphs, trees, hashtables, sorting, and Big-O — plus discrete math, operating-system concurrency, and one language you know deeply.
