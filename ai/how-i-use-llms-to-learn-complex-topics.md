...
created: 2026-08-13
description: "LLMs are used for any things. Learning new things is one of the top use cases."
tags:
  - "clippings"
---

> [!summary]
> The author finds LLM prose explanations too simplistic to retain, so instead of asking for an explanation he has the model build a foundational knowledge base on a topic, review its own accuracy, then generate an interactive low-poly RollerCoaster Tycoon-style simulation of the process and deploy it to GitHub Pages. He applied this to chip fabrication (ChipTycoon), and also to rocket engines, LLM internals, F1 engines, and EUV lithography. Suggested improvements include mapping in real 3D assets and adding quizzes and puzzles about earlier steps to reinforce retention.
