...
> [!summary]
> A hands-on 7-week course for building production-grade RAG (Retrieval-Augmented Generation) systems, progressing from infrastructure setup through keyword search, hybrid search, LLM integration, monitoring/caching, to agentic RAG with LangGraph and Telegram bot integration.
...
[![RAG Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/mother_of_ai_project_rag_architecture.gif)](https://github.com/jamwithai/production-agentic-rag-course#-about-this-course)
...
[![Week 7 Telegram and Agentic AI Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week7_telegram_and_agentic_ai.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week7_telegram_and_agentic_ai.png)

*Complete Week 7 architecture showing Telegram bot integration with the agentic RAG system*

### LangGraph Agentic RAG Workflow

[![LangGraph Agentic RAG Flow](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/langgraph-mermaid.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/langgraph-mermaid.png)
...
| Service | URL | Purpose |
| --- | --- | --- |
| **API Documentation** | [http://localhost:8000/docs](http://localhost:8000/docs) | Interactive API testing |
| **Gradio RAG Interface** | [http://localhost:7861](http://localhost:7861/) | User-friendly chat interface |
| **Langfuse Dashboard** | [http://localhost:3000](http://localhost:3000/) | RAG pipeline monitoring & tracing |
| **Airflow Dashboard** | [http://localhost:8080](http://localhost:8080/) | Workflow management |
| **OpenSearch Dashboards** | [http://localhost:5601](http://localhost:5601/) | Hybrid search engine UI |

#### NOTE: Check airflow/simple\_auth\_manager\_passwords.json.generated for Airflow username and password
...
[![Week 1 Infrastructure Setup](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week1_infra_setup.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week1_infra_setup.png)
...
**Completion Guide:** Follow the [Week 1 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week1/week1_setup.ipynb) for hands-on setup and verification steps.
...
[![Week 2 Data Ingestion Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week2_data_ingestion_flow.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week2_data_ingestion_flow.png)
...
**Completion Guide:** Follow the [Week 2 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week2/week2_arxiv_integration.ipynb) for hands-on implementation and verification steps.
...
[![Week 3 OpenSearch Flow Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week3_opensearch_flow.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week3_opensearch_flow.png)
...
**Completion Guide:** Follow the [Week 3 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week3/week3_opensearch.ipynb) for hands-on OpenSearch setup and BM25 search implementation.
...
[![Week 4 Hybrid Search Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week4_hybrid_opensearch.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week4_hybrid_opensearch.png)
...
**Completion Guide:** Follow the [Week 4 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week4/week4_hybrid_search.ipynb) for hands-on implementation and verification steps.
...
[![Week 5 Complete RAG System Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week5_complete_rag.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week5_complete_rag.png)
...
**Completion Guide:** Follow the [Week 5 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week5/week5_complete_rag_system.ipynb) for hands-on LLM integration and RAG pipeline implementation.
...
[![Week 6 Monitoring & Caching Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week6_monitoring_and_caching.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week6_monitoring_and_caching.png)
...
**Completion Guide:** Follow the [Week 6 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week6/week6_cache_testing.ipynb) for hands-on Langfuse tracing and Redis caching implementation.
...
[![Week 7 Agentic RAG & Telegram Architecture](https://github.com/jamwithai/production-agentic-rag-course/raw/main/static/week7_telegram_and_agentic_ai.png)](https://github.com/jamwithai/production-agentic-rag-course/blob/main/static/week7_telegram_and_agentic_ai.png)
...
**Completion Guide:** Follow the [Week 7 notebook](https://github.com/jamwithai/production-agentic-rag-course/blob/main/notebooks/week7/week7_agentic_rag.ipynb) for hands-on LangGraph agentic RAG and Telegram bot implementation.
...
**Complete Configuration:** See [.env.example](https://github.com/jamwithai/production-agentic-rag-course/blob/main/.env.example) for all available options and detailed documentation.
...
**API Documentation:** Visit [http://localhost:8000/docs](http://localhost:8000/docs) for interactive API explorer
...
[![Star History Chart](https://camo.githubusercontent.com/a50477563348d665e8a9c2269ef46784d60d1150104ffdfdf221ffaad803c801/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f7376673f7265706f733d6a616d7769746861692f70726f64756374696f6e2d6167656e7469632d7261672d636f7572736526747970653d44617465)](https://star-history.com/#jamwithai/production-agentic-rag-course&Date)

---

## 📄 License

MIT License - see [LICENSE](https://github.com/jamwithai/production-agentic-rag-course/blob/main/LICENSE) file for details.
