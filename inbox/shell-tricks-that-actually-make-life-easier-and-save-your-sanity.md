...
source: "https://blog.hofstede.it/shell-tricks-that-actually-make-life-easier-and-save-your-sanity/"
author:
...
> [!summary]
> A curated collection of shell productivity tricks split into two categories: universal POSIX tricks (Ctrl+W, Ctrl+U/K/Y, reset, cd -, set -euo pipefail) and Bash/Zsh-specific features (Ctrl+R history search, !!, brace expansion, process substitution, globstar, backgrounding with disown). Practical and focused on daily workflow improvement.
