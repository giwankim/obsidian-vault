---
title: "CCC vs GCC"
source: "https://harshanu.space/en/tech/ccc-vs-gcc/"
author:
  - "[[Harshanu]]"
...
[![GCC Compilation Stages](https://miro.medium.com/v2/resize:fit:640/format:webp/1*YummodV7MDImgo0ywwmxlA.png)](https://medium.com/@gpradinett/the-four-stages-of-the-gcc-compiler-preprocessor-compiler-assembler-linker-3dec8714bb9c) *Image credit: [The four stages of the gcc compiler](https://medium.com/@gpradinett/the-four-stages-of-the-gcc-compiler-preprocessor-compiler-assembler-linker-3dec8714bb9c)*
...
| **Kernel** | Linux 6.9 (x86\_64 defconfig) |
| **SQLite** | SQLite 3.46.0 amalgamation |
| **Monitoring** | `/usr/bin/time -v`, custom system metrics logger (CPU%, RSS every 5s) |

CCC was built with the `gcc_m16` Cargo feature, which delegates 16-bit real-mode boot code (`-m16` flag) to GCC. This is needed because CCC’s i686 backend produces code too large for the 32KB real-mode limit. The x86\_64 C code is compiled entirely by CCC.
