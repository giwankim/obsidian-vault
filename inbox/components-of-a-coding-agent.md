...
source: "https://magazine.sebastianraschka.com/p/components-of-a-coding-agent?utm_campaign=email-half-post&r=8x3s&utm_source=substack&utm_medium=email"
author:
  - "[[Sebastian Raschka]]"
  - "[[PhD]]"
...
> [!summary]
> Sebastian Raschka walks through six core building blocks of a coding agent harness — live repo context, prompt shape and cache reuse, structured tool access, context-bloat compaction, structured session memory, and bounded subagent delegation. He argues the harness, not the raw model, is now the main differentiator between products like Claude Code and Codex, and points to his open-source Mini Coding Agent as a minimal reference implementation.
