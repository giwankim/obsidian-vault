...
created: 2026-09-16
description: "Effective writing for software developers"
tags:
  - "clippings"
---

> [!summary]
> Michael Lynch (ex-Google, ex-Microsoft) lays out what belongs in a software design doc and what does not, anchored to a complete worked example doc he wrote for a real web app. Enumerates roughly twenty candidate sections — objective, background, goals and non-goals, scenarios, interfaces, SLOs, security, privacy, open issues, alternatives considered — and a heuristic for how much to invest based on the cost of getting the design wrong. Closes with advice on driving the doc through review.
...
So, I wrote [a design doc from scratch](https://refactoringenglish.com/excerpts/write-an-effective-design-doc/little-moments-design-doc/) based on the principles I’m sharing here. It lays out the design for [a real web app I’m building](https://codeberg.org/mtlynch/little-moments).
 ...
 <video controls=""><source src="https://refactoringenglish.com/excerpts/write-an-effective-design-doc/little-moments-demo.mp4" type="video/mp4"> Your browser does not support the video tag.</video>
...
![Architecture diagram](https://refactoringenglish.com/excerpts/write-an-effective-design-doc/architecture-diagram.svg)
