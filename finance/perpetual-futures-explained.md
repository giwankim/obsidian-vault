...
You may have read a lot about stablecoins recently. I may write about them (again; see [past BAM issue](https://www.bitsaboutmoney.com/archive/stablecoin-mechanisms-and-use-cases/)) in the future, as there has in recent years been [some uptake](https://www.stablecoin.fyi/) of them for payments. But it is useful to understand that a plurality of stablecoins collateralize perps. Some observers are occasionally *strategic* in whether they acknowledge this, but for payments use cases, it does not require a lot of stock to facilitate massive flows. And so of the [$300 billion or so in stablecoins presently outstanding](https://defillama.com/stablecoins), [about a quarter](https://cryptoquant.com/asset/stablecoin/chart/exchange-flows/exchange-reserve?exchange=all_exchange&window=DAY&sma=0&ema=0&priceScale=log&metricScale=linear&chartStyle=line) sit on exchanges. The majority of that is collateralizing perp positions.

Perps are the dominant way crypto trades, in terms of volume. (It bounces around but is typically [6-8 times larger than spot](https://cryptoquant.com/insights/quicktake/691f2c39e69e12693d3aa0bf-Spot-vs-Derivative-Volume-Ratio-Are-Real-Buyers-Taking-Control).) This is similar to most traditional markets: where derivatives are available, derivative volume swamps spot volume. The degree to which depends on the market, Schelling points, user culture, and similar. For example, in India, most retail investing in equity is actually through derivatives; this is not true of the U.S. In the U.S., most retail equity exposure is through the spot market, directly holding stocks or indirectly through ETFs or mutual funds. Most *trading volume of the stock indexes*, however, is via derivatives.
...
One fun wrinkle for funding rates: some exchanges cap the amount the rate can be for a single settlement period. This is similar in intent to traditional markets’ usage of [circuit breakers](https://www.nyse.com/publicdocs/nyse/NYSE_MWCB_FAQ.pdf): designed to automatically blunt out-of-control feedback loops. It is dissimilar in that it cannot actually break circuits: changes to funding rate can delay realization of losses but can’t prevent them, since they don’t prevent the realization of symmetrical gains.
...
In a standard U.S. brokerage account, [Regulation T](https://www.ecfr.gov/current/title-12/chapter-II/subchapter-A/part-220?toc=1) has, for almost 100 years now, set maximum leverage limits (by setting minimums for margins). These are 2X at position opening time and 4X “maintenance” (before one closes out the position). Your brokerage would be obligated to forcibly close your position if volatility causes you to exceed those limits.
...
Perps are offered at 1X (non-levered exposure). But they’re [routinely offered](https://www.binance.com/en/square/post/24757521817370) at 20X, 50X, and 100X. SBF, during his press tour / regulatory blitz about being a responsible financial magnate fleecing the customers *in an orderly fashion*, voluntarily [self-limited FTX to 20X](https://www.coindesk.com/markets/2021/07/25/ftx-cuts-leverage-limit-to-20x-from-100x-as-criticism-of-margin-trading-in-crypto-grows).
...
Blowing out losing traders is lucrative for exchanges except when it catastrophically isn’t. It is a priced service in many places. The price is quoted to be low ([“a nominal fee of 0.5%](https://www.binance.com/en/square/post/26755786144026) ” is one way Binance describes it) but, since it is calculated from the amount at risk, it can be a large portion of the money lost. If the account’s negative balance is less than the liquidation fee, wonderful, thanks for playing and the exchange / “the insurance fund” keeps the rest, as a tip.
...
Then crypto [gets reminded](https://unchainedcrypto.com/the-chopping-block-inside-the-19b-perp-crash-adl-explained-binances-usde-staked-token-depeg-and-the-hyperliquid-whale-debate/) about automatic deleveraging (ADL), a detail to perp contracts that few participants understand.

## We have altered the terms of your unregulated futures investment contract.

([Pray we do not alter them further.](https://www.youtube.com/watch?v=3D8TEJtQRhw))
...
In theory, this can happen to the upside or the downside. *In practice* in crypto, this seems to usually happen after sharp decreases in prices, not sharp increases. For example, October 2025 saw widespread ADLing as (more than) [$19 billion of liquidations](https://www.bloomberg.com/news/articles/2025-11-22/crypto-s-brutal-month-triggers-a-stress-test-for-wall-street) happened, across a variety of assets. Alameda’s CEO Caroline Ellison [testified](https://www.wsj.com/livecoverage/sam-bankman-fried-trial-ftx-caroline-ellison/card/alameda-research-lost-100-million-on-terrausd-uhsJkMxHAu4TU4PJV9Kd?gaa_at=eafs&gaa_n=AWEtsqcUTBS1ClKudIOSulhPczCueQrmHacrKc48MbNkyWvrvttdiJEOV6gGYvaIfpg%3D&gaa_ts=692e37a5&gaa_sig=OrKMG6Tx7IV1mr9NebTACUXOFFABpI3lO-JBghpvChgBNyGFFAN1xPsB-zf6tnqA0JoIWdfvQPbD7ne_aFDiVQ%3D%3D) that they lost over $100 million during the collapse of Terra’s stablecoin in 2022, but since FTX’s insurance fund [was made up](https://www.theblock.co/post/255352/ftx-used-random-numbers-to-generate-the-size-of-its-insurance-fund); when leveraged traders lost money, their positions were frequently taken up by Alameda. That was quite lucrative much of the time, but catastrophically expensive during e.g. the Terra blowup. Alameda was a good loser and paid the winners, though: with other customers’ assets that they “borrowed.”
...
One of the reasons this behavior is so adaptive is because the billions of dollars sloshing around can be described to banks as “proprietary trading” and “running an OTC desk”, and an inattentive bank (like, say, Silvergate, as [recounted here](https://www.bitsaboutmoney.com/archive/debanking-and-debunking/)) might miss the customer fund flows they would have been formally unwilling to facilitate. This is a useful feature for sophisticated crypto participants, and so some of them do not draw attention to the elephant in the room, even though it is averse to their interests.
