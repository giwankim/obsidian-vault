...
source: "https://lukasniessen.medium.com/this-is-a-detailed-breakdown-of-a-fintech-project-from-my-consulting-career-9ec61603709c"
author:
  - "[[Lukas Niessen]]"
...
> [!summary]
> A software architect's detailed breakdown of re-architecting a FinTech trading platform from a monolith to event sourcing, CQRS, and microservices to meet auditability and scalability requirements. It covers concrete trade-offs — event sourcing only in the Transaction-Portfolio service for compliance, snapshots every 1,000 events to fix replay performance, tiered storage, and CQRS with separate Postgres/MongoDB stores added only where the complexity is justified.

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*V8QyooPGv4p3ZqUfGc6lcQ.jpeg)
