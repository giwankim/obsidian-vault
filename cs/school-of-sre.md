---
title: "School Of SRE"
source: "https://linkedin.github.io/school-of-sre/"
author:
published:
created: 2026-07-26
description:
...
> [!summary]
> LinkedIn's open-sourced SRE curriculum, built to onboard new college grads and non-traditional lateral hires into the Site Engineering team after campus recruiting surfaced how little beginner-level SRE material exists.
> Level 101 covers Linux basics, Git, Linux networking, Python and web, relational and NoSQL databases, big data, systems design, metrics and monitoring, and security; Level 102 adds intermediate/advanced Linux, containers and orchestration, system calls and signals, networking, system design, troubleshooting and performance, and CI/CD.
> The emphasis is on foundational skills that transfer across any infrastructure stack — proprietary, third-party, cloud, or on-prem — with per-module references for continued study.
