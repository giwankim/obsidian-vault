...
> [!summary]
> Thomas Finley's Cornell course notes on two's complement: to negate an integer, invert the bits and add one, with a leading 1 marking negatives. Worked 32-bit examples show subtraction reducing to addition of a negated operand, which lets hardware share one adder. The final section derives the invert-and-add-one trick from long-hand subtraction of the number from 2^n, where subtracting from all-ones is bitwise inversion.
...
| ``` 000000 -    3 ------ ``` | ``` 1 000000 -    3 ------      7 ``` | ``` 11 000000 -    3 ------     97 ``` | ``` 111 000000 -    3 ------    997 ``` | ``` 1111 000000 -    3 ------   9997 ``` |
| --- | --- | --- | --- | --- |

Et cetera, et cetera. We'd wind up with a number composed of a 7 in the one's digit, a 9 in every digit more significant than the 10 <sup>0</sup> 's place.

### The Same in Binary

We can do more or less the same thing with binary. In this example I use 8 bit binary numbers, but the principle is the same for both 8 bit binary numbers (chars) and 32 bit binary numbers (ints). I take the number 75 (in 8 bit binary that is 01001011 <sub>2</sub>) and subtract that from zero.

Sometimes I am in the position where I am subtracting 1 from zero, and also subtracting another borrowed 1 against it.

| ``` 00000000 - 01001011 ---------- ``` | ``` 1   00000000 - 01001011 ----------          1 ``` | ``` 11   00000000 - 01001011 ----------         01 ``` | ``` 111   00000000 - 01001011 ----------        101 ``` | ``` 1111   00000000 - 01001011 ----------       0101 ``` |
| --- | --- | --- | --- | --- |
| ``` 11111   00000000 - 01001011 ----------      10101 ``` | ``` 111111   00000000 - 01001011 ----------     110101 ``` | ``` 1111111   00000000 - 01001011 ----------    0110101 ``` | ``` 11111111   00000000 - 01001011 ----------   10110101 ``` |  |
...
So to find the negative of an n-bit number in a computer, subtract the number from 0 or subtract it from 2 <sup>n</sup>. In binary, this power of two will be a one bit followed by n zero bits.
