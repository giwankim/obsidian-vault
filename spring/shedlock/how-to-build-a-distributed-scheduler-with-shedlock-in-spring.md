---
title: "How to Build a Distributed Scheduler with ShedLock in Spring"
source: "https://oneuptime.com/blog/post/2026-01-25-distributed-scheduler-shedlock-spring/view"
author:
  - "[[Nawaz Dhandala]]"
...
> [!summary]
> A hands-on guide to preventing duplicate scheduled task execution across multiple Spring Boot instances using ShedLock's database-backed distributed locking. It walks through JDBC and Redis lock providers, the shedlock table schema, and tuning `lockAtMostFor`/`lockAtLeastFor` per task. Also covers testing task logic with Mockito and production concerns like lock extension for long-running jobs, clock synchronization, and graceful shutdown.
...
Technically validated · Jun 15, 2026
...
[Edit this post on GitHub](https://github.com/oneuptime/blog/tree/master/posts/2026-01-25-distributed-scheduler-shedlock-spring) [Contributing guidelines](https://github.com/oneuptime/blog)
