...
source: "https://www.raphaelbauer.com/posts/postgresql-everything/"
author:
  - "[[Dr. Raphael A. Bauer]]"
published: 2024-02-14
created: 2026-08-21
description: "You need simplicity if you want to move fast. PostgreSQL can very well replace Kafka, Redis, Clickhouse and Elastic. And many successful companies are doing exactly that. Let's check out how."
tags:
  - "clippings"
---

> [!summary]
> Raphael Bauer argues that PostgreSQL is rock-solid, easy to operate, and capable enough to replace most of the specialized systems in a typical stack, and that the resulting simplicity is what lets teams move fast.
> He walks through the substitutions one by one: built-in full-text search instead of Solr/Elastic, JSON support instead of MongoDB, table-based queues instead of Kafka/RabbitMQ, TimescaleDB for high-volume time series instead of Clickhouse, pgvector/pgai for AI workloads, UNLOGGED tables for Redis-style caching, blob columns instead of the filesystem, and the LTREE datatype for hierarchical data.
> His rule of thumb: when a new requirement shows up, first ask whether PostgreSQL can already do it before adopting shiny technology X.
...
- [Three Strike Dismissal in One-On-Ones](https://www.raphaelbauer.com/posts/three-strikes-one-on-one/)
...
- [Effective Meetings](https://www.raphaelbauer.com/posts/effective-meetings/)
	Most meetings are a waste of time. Let's check out the best way to change that!
- [What makes leaders effective?](https://www.raphaelbauer.com/posts/drucker-on-effective-leaders/)
