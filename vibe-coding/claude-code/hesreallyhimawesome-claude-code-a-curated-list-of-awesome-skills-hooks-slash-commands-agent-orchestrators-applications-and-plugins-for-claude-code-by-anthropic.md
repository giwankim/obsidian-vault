...
> [!summary]
> A curated GitHub repository listing skills, hooks, slash-commands, agent orchestrators, workflows, tooling, and plugins for Claude Code. Covers categories including agent skills, workflow guides, IDE integrations, status lines, hooks, CLAUDE.md templates, and alternative clients.

### Pick Your Style:

![Awesome Claude Code](https://github.com/hesreallyhim/awesome-claude-code/raw/main/assets/awesome-claude-code-social-clawd-leo.png)
