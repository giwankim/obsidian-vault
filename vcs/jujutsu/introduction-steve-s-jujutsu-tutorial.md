...
source: "https://steveklabnik.github.io/jujutsu-tutorial/introduction/introduction.html"
author:
published:
created: 2026-05-26
description:
...
> [!summary]
> Steve Klabnik introduces his learn-as-you-go tutorial for Jujutsu (`jj`), a Git-compatible version control system. He recounts being a rare `git` CLI defender who initially bounced off `jj`, then returned after Chris Krycho's "jj-init" essay clicked for him, and is now publishing his notes in case they help other learners — with no claim that the tutorial is complete or accurate.
...
Well, recently [Chris Krycho wrote an article about `jj`](https://v5.chriskrycho.com/essays/jj-init/). I liked it. I didn't fully grok everything, but it at least felt like I could understand this thing finally maybe. I didn't install it, but just sat with it for a while.

I don't know if that is why, but I awoke unusually early one morning. I couldn't get back to sleep. Okay. Fine. Let's do this. I opened up [the official `jj` tutorial](https://docs.jj-vcs.dev/v0.13.0/tutorial/), installed `jj`, made this repository on GitHub, followed the "cloning a git repo" instructions to pull it down, and started this mdBook.
