...
> [!summary]
> A reference guide to Git's special committed files: .gitignore, .gitattributes, .mailmap, .git-blame-ignore-revs, .lfsconfig, and more — explaining how each controls Git's behavior for line endings, language detection, blame filtering, and LFS.
