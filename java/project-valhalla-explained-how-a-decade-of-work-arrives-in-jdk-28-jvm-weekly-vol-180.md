---
title: "Project Valhalla, Explained: How a Decade of Work Arrives in JDK 28 - JVM Weekly vol. 180"
source: "https://www.jvm-weekly.com/p/project-valhalla-explained-how-a?hide_intro_popup=true"
author:
  - "[[Artur Skowronski]]"
published: 2026-06-18
created: 2026-06-21
description: "The new JVM Weekly is here... and Ragnarok seems to come, as we finally have Valhalla in the JDK. However, situation is a bit... nuanced."
tags:
  - "clippings"
---

> [!summary]
> A deep-dive on Project Valhalla, tracing twelve years of design (the discarded "Q World," the breakthrough "L World," and the naming evolution from value types → inline classes → primitive classes → today's value classes) up to JEP 401 landing as a *preview* in JDK 28. The core idea — "codes like a class, works like an int" — lets you declare identity-free `value class`es that the JVM can scalarize and heap-flatten for dense, cache-friendly memory layouts without sacrificing class abstraction. Key caveats: it's preview/disabled-by-default, value objects can still be null (non-nullable types are a future JEP), `==` now means substitutability, and flat generic collections await specialized generics still to come.
...
![Article cover image](https://substackcdn.com/image/fetch/$s_!3GhD!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4d9124f8-8a73-453b-88e2-7df5c98022ec_1920x1080.png)
...
![](https://substackcdn.com/image/fetch/$s_!Nxmc!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0333ea9a-5db7-4b0b-9dfe-ae446b56b623_737x374.png)
...
![](https://substackcdn.com/image/fetch/$s_!TXj2!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffb8578c0-ca06-4821-b945-ea9609626526_725x172.png)
...
![](https://substackcdn.com/image/fetch/$s_!T4O3!,w_1456,c_limit,f_webp,q_auto:good,fl_lossy/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd61784ec-6d2a-43ea-8b7a-ca0d9ee7d512_640x262.gif)
...
![](https://substackcdn.com/image/fetch/$s_!BvJy!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcb5f166e-2c27-4ead-94f3-cf49cf09191a_1314x638.png)
...
![](https://substackcdn.com/image/fetch/$s_!6-Rq!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb98703ea-c366-439e-8e2e-6cbddd74b4ab_1525x1004.png)
...
![](https://substackcdn.com/image/fetch/$s_!SLqA!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6176d42d-70e2-4032-93ce-569168be54a0_555x608.png)
...
![](https://substackcdn.com/image/fetch/$s_!lDtT!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcf1a00b3-2a2f-4fc1-995c-046e48ed294d_746x472.png)
...
![](https://substackcdn.com/image/fetch/$s_!lV_z!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda358d54-831b-4a66-8cc2-4cdec25b2add_1533x1021.png)
