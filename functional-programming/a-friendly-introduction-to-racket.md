...
> [!summary]
> Traces Lisp's lineage from McCarthy's 1958 original through Scheme and PLT Scheme to modern Racket, arguing the parentheses are the absence of arbitrary syntax rules rather than an obstacle. Walks through installation, expressions, `define`/`lambda`, list operations, higher-order functions (`map`/`filter`/`foldl`), and recursion, ending with a Sierpinski triangle drawn via the bundled `2htdp/image` library. Closes on homoiconicity: because code is just quoted lists, `define-syntax-rule` lets you add missing constructs like `while` to the language yourself.

![steal-your-face-plt](https://bear-images.sfo2.cdn.digitaloceanspaces.com/mothcodes/steal-your-face-plt.svg)
...
![TADC](https://bear-images.sfo2.cdn.digitaloceanspaces.com/geometridae/tadc.webp)
...
1. Go to [https://racket-lang.org](https://racket-lang.org/)
...
![Kurosawa_Ruby_Holding_SICP](https://bear-images.sfo2.cdn.digitaloceanspaces.com/geometridae/kurosawa_ruby_holding_sicp.webp)

- **[How to Design Programs](https://htdp.org/)** — the book Racket was designed around, free online.
- **[The Racket Guide](https://docs.racket-lang.org/guide/)** — official documentation, among the best out there.
- **[Beautiful Racket](https://beautifulracket.com/)** — learn to build your own languages.
