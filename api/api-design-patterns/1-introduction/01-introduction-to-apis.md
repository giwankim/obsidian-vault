...
One special type of API is built to be exposed over a network and used remotely by lots of different people, often called "web APIs."
...
But this doesn't stop at automation. APIs also open the door to composition, which allows us to treat functionality like Lego building blocks.
