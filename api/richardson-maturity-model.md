...
created: 2026-07-08
description: "Leonard Richardson's model for understanding a RESTful architecture as steps in a maturity model. Levels are (1) resources, (2) HTTP verbs and return codes, and (3) hypertext controls."
tags:
  - "clippings"
---

> [!summary]
> Explains Leonard Richardson's maturity model for REST as four levels, illustrated throughout with a doctor-appointment booking example. Level 0 uses HTTP as a plain RPC tunnel to a single endpoint; Level 1 introduces addressable resources; Level 2 uses HTTP verbs and status codes properly (safe GETs, 201/409, caching); Level 3 adds hypermedia controls (HATEOAS) for discoverability. Fowler notes Fielding considers Level 3 a precondition for true REST, and frames the model as a learning tool rather than an assessment scorecard.
